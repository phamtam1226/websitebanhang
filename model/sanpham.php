...
function inser_product($iddm, $tensp, $gia, $img, $new, $view, $db,$manhinh, $hedieuhanh)
{
    $conn  = connectdb();
    $sql = "INSERT INTO tb_sanpham (iddm, tensp,gia, img,new,view,db,manhinh,hedieuhanh)
    VALUES ('" . $iddm . "','" . $tensp . "','" . $gia . "','" . $img . "','" . $new . "','" . $view . "','" . $db . "','" . $manhinh . "','" . $hedieuhanh . "')";
                    ...
                    <div class="card h-100">
                       <form action="index.php?act=addcart" method="post">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><input class="btn btn-outline-dark mt-auto" type="submit" value="Thêm vào giỏ hàng" name="addcart"> </div>
                            </div>
