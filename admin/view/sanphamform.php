            ...
            <form action="index.php?act=suasp" method="POST" class="mb-2 col-12 mx-auto" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <h2 class="text-light" > Thông số kỹ thuật</h2>
                        <div class="form-group">
                          
                            <label for="my-select" class="text-light">Màn hình:</label>
                            <input id="my-input" class="form-control" type="text" name="manhinh"
                            value="<?= $kqone[0]['manhinh'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="my-select" class="text-light">Hệ điều hành:</label>
                            <input id="my-input" class="form-control" type="text" name="hedieuhanh"
                            value="<?= $kqone[0]['hedieuhanh'] ?>">
                        </div>
